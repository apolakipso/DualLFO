...
const int analogPot1Pin = A2;
const int analogPot2Pin = A3;

const int analogOut1Pin = 5;
const int analogOut2Pin = 6;

const int DigitalIn1Pin = 8;
const int DigitalIn2Pin = 9;

const int DigitalOut1Pin = 3;
const int DigitalOut2Pin = 4;

const int Switch1Up = A4;
const int Switch1Dwn = A5;

const int Switch2Up = 7;
const int Switch2Dwn = 2;

const unsigned char sines[] = {
